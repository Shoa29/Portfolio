!function() {
    ...
    var t = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t) {
      ...
      , e = window.Circles = function(t) {
        var e = t.id;
        if (this._el = document.getElementById(e),
        null !== this._el) {
    ...
    e.prototype = {
        ...
        _generatePath: function(t, e, i) {
            ...
            return s.setAttribute("fill", "transparent"),
        ...
        htmlifyNumber: function(t, e, i) {
            e = e || "circles-integer",
            i = i || "circles-decimals";
            var s = (t + "").split(".")
              , r = '<span class="' + e + '">' + s[0] + "</span>";
            return s.length > 1 && (r += '.<span class="' + i + '">' + s[1].substring(0, 2) + "</span>"),
            r
        },
        ...
        update: function(e, i) {
            ...
            var s, r, n, a, h = this, u = h.getPercent(), _ = 1;
